...
def getBaiDuFaceTech(imgPath,access_token):
    ...
    params = {"image":img,"image_type":"BASE64","face_field":"age,beauty,expression,faceshape,gender,glasses,landmark,race,qualities","max_face_num":5}
    ...
    #如果没有发现人像，会返回空
    try:
        if face_json['error_code'] == 222202:
            face_dict={}
        #百度人脸检测v3
        else:
